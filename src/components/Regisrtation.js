...
function Registration(props) {
  ...
  return (
    <div className="text-left regi">
      <div className="register col-4 m-auto">
        <p className="fsize text-center text-white font-weight-normal">
          REGISTRATION FORM
        </p>
        <form className="shadow p-3 mb-5 bg-white rounded text-left">
          <div className="form-group p-2 ">
            ...
            <div className="row">
              <div className="">
                <input
                  className="bg-light form-control form-control-sm widthchange mt-2"
                  type="firstName"
                  name="firstName"
                  value=""
